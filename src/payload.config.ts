...
import { Products, ProductCategories, ProductCategoryGroups } from './cms/collections/Products';
...
export default buildConfig({
  ...
  collections: [Users, Media, Products, ProductCategories, ProductCategoryGroups, ContentPages],
